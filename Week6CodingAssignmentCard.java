...
public class Week6CodingAssignmentCard {
    ...
    // Creates the deck through a method which which assigns the suits to the cards, and also their values. Returns the completed
    // deck of 52 cards.
